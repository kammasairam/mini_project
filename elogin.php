...
<div class="navbar">
  ...
  <a class="active" href="elogin.php">Employee Login</a> 
...
<center><h1><font color="red" size="6">Employee login</font></h1></center>
...
if(!empty($_POST['user']) && !empty($_POST['pass'])) {  
   ...
   mysqli_select_db($con,'id12623400_ghmc') or die("cannot select DB");  
    ...
    echo "<b><center>Invalid username or password!</center></b>";  
    }  
  
} else {  
    echo "<b><center>All fields are required!</b></center>";  
}  
}  
?>
